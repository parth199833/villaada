	...
	return (
		...
		>
			<div className="absolute inset-x-0 top-[10%] z-10 mx-auto flex max-w-2xl flex-col items-center space-y-4 text-center sm:top-[15%] lg:space-y-5 xl:space-y-8">
				<h3 className="text-center text-3xl font-bold !leading-[115%] text-white sm:text-4xl md:text-3xl lg:text-3xl xl:text-5xl">
					Surrounding
				</h3>
				<Link
					href={`/home-3`}
					className="rounded-xl px-6 py-3 text-white lg:px-8 lg:py-4"
